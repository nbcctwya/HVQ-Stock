"""Tests for experiment 031's market-gated MASTER Stage 1 encoder."""
...
class MarketGatedMASTERStage1EncoderTest(unittest.TestCase):
    ...
    def test_only_market_gate_is_added_to_experiment_027_encoder(self):
