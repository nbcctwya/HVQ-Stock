"""Stage 1 encoder layers ported verbatim from experiment 031.
...
This file is reused frozen by experiment 035 as its Stage 1 encoder (ported
from experiment 031 without any algorithmic change).
"""
...
class SpatialEncoder(nn.Module):
    """Stage 1: Market Gate + MASTER-style encoder + MLP projection."""
    ...
    def __init__(self,
        ...
        if encoder_type != "master":
            raise ValueError(
                "MASTER-style Stage 1 requires vqvae.encoder.type='master'"
            )
