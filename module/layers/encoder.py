"""Stage 1 encoder layers ported verbatim from experiment 027.
...
This file is reused frozen by experiment 033 as its Stage 1 encoder (ported
from experiment 027 without any algorithmic change).
"""
